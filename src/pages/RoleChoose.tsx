            ...
            <div className="flex items-center bg-[#000000] flex-col gap-[49px] p-[80px]">
                ...
                <div className="flex justify-center gap-[38px] w-[1080px]">
                    <div className="flex flex-col gap-[20px] items-center">
                        <div onClick={() => HandleGetSL() == "SignIn" ? navigate("/signin/store") : navigate("/signup/store")} className="flex items-center justify-center w-[258px] h-[298px] rounded-[14px] bg-[#251B03] cursor-pointer">
                            <img src="/images/Home/Frame 11.svg" alt="" />
                        </div>
                        <h6 className="text-[#FFD451] font-[300] text-[1.4rem]">store</h6>
                    </div>
                    <div className="flex flex-col gap-[20px] items-center">
                        <div onClick={() => HandleGetSL() == "SignIn" ? navigate("/signin/courier") : navigate("/signup/courier")} className="flex items-center w-[258px] h-[298px] justify-center p-[42px_37px] rounded-[14px] bg-[#251B03] cursor-pointer">
                            <img src="/images/Home/Rectangle 17 (3).svg" alt="" />
                        </div>
                        <h6 className="text-[#FFD451] font-[300] text-[1.4rem]">courier</h6>
                    </div>
                    <div className="flex flex-col gap-[20px] items-center">
                        <div onClick={() => HandleGetSL() != "SignUp" && navigate("/signin/admin")} className={`flex w-[258px] h-[298px] items-center justify-center p-[42px_37px] rounded-[14px] bg-[#251B03] ${HandleGetSL() === "SignIn" ? "cursor-pointer" : "bg-[#130e03]!"} `}>
