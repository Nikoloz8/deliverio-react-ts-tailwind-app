        ...
        <>
            <div className={`fixed transition-all duration-1000 left-1/2 z-20 -translate-x-1/2 -translate-y-1/2 top-[-300px] flex items-end gap-[24px] ${showForm && "top-1/2!"}`}>
                <div className="flex gap-[20px] items-end">
                    <form action="" onSubmit={handleSubmit(() => handleSaveForm(status))} className="flex flex-col gap-[21px] p-[32px] ml-[340px] bg-[#111111] rounded-[8px]">
                        ...
                        {getRole() === "admin" &&
                            <div className="flex flex-col gap-[8px] z50 items-start">
                                <label className="font-[275] cursor-pointer text-[#FFFFFF] text-[1.4rem] leading-[100%]">Status</label>
                                <StatusTab order={order} status={status} edit={true} />
                            </div>
                        }
                        <div className="flex justify-center">
                            <div className="flex items-center gap-[6px]">
                                ...
                                <button onClick={() => {
                                    setShowForm(false)
                                    setShowChangeStatus(false)
                                }} type="button" className="bg-transparent rounded-[6px] p-[8px_32px] font-[300] text-[#FFFFFF] text-[1.4rem] leading-[100%] cursor-pointer">Cancel</button>
                            </div>
                        </div>
                    </form>
                    <div className={`transition-all duration-1000 p-[24px] bg-[#111111] border-[0.8px] border-solid border-[#363636] rounded-[8px] right-[-540px] w-[324px] opacity-[100%] flex-col gap-[16px] shadow-[0_0_4px_0_#00000040] flex items-start ${!showChangeStatus && "opacity-0! pointer-events-none"}`}>
