            ...
            <div className="flex p-[13px_40px] justify-between w-[1080px]">
                ...
                <nav className="flex gap-[42px] items-center">
                    <div className="flex items-center gap-[28px]">
                        <a href="" className={`${HeaderFont} ${location.includes("role-choose") && `p-[12px_24px]! ${HeaderFont} text-[#FF9900]! bg-[#251B03] rounded-[8px] cursor-pointer`} ${location.includes("signin") || location.includes("signup") || location.includes("panels") ? "p-[12px_18px]! border-[#FFFFFF33]! border-[1px]! text-[1.4rem]! leading-[100%]! font-[400]! border-solid! rounded-[8px]! bg-transparent!" : ""}`}>{location.includes("panels") ? "Log Out" : "About Us"} </a>
